...
Generated = "NT" + random.choice(string.ascii_letters) + ''.join(random.choice(string.ascii_letters + string.digits) for _ in range(10)) + "." + random.choice(string.ascii_letters).upper() + ''.join(random.choice(string.ascii_letters + string.digits) for _ in range(5)) + "" + ''.join(random.choice(string.ascii_letters + string.digits) for _ in range(10))
...
if __name__ == "__main__":
    url_to_open = "https://discord.com/register?email=" + Generated + "@zbock.com" #+ RestoreCloud + "?test"
